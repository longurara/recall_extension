...
export const DEFAULT_SETTINGS = {
  ...
  aiRequireConfirm: true,        // Ask before sending content to external AI
  aiBlockedDomains: [            // Do not send these domains to AI
    'localhost',
    '127.',
    '10.',
    '192.168.',
  ...
  // Feature: AI Enhanced
  aiAutoTagEnabled: false,       // Auto-tag snapshots using AI after capture
  aiAutoInsights: false,         // Auto-generate insights for new snapshots
};
...
export const MSG = {
  ...
  AI_WEEKLY_DIGEST: 'AI_WEEKLY_DIGEST',
  AI_PAGE_INSIGHTS: 'AI_PAGE_INSIGHTS',
  AI_MEMORY_CHAT: 'AI_MEMORY_CHAT',
